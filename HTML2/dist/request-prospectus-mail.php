...
mail("admissions@ish-edu.com, mukesh.thankar@syspiretechnologies.com", "Enquiry From Request Prospectus", $message, $headers );
...
$message1 = "<html><head></head><body>";
 ...
 $message1 .="
 	...
 	<div>
		...
		A digital copy of your prospectus will reach your inbox at the earliest.<br/><br/> 
...
echo "<script>window.location.href = 'request-after-submission.html'</script>"
//header("Location:request-after-submission.html");
?>