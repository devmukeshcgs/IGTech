...
mail("admissions@ish-edu.com, mukesh.thankar@syspiretechnologies.com", "Enquiry From Open Days Page", $message, $headers );
...
// echo "<script>window.location.href = 'openday-thank-you.html'</script>"
// 
//Send to Visitor
